...
- **Email:** privacy@activimpact.ai (verified)
- **Method:** email — Statutory request by email. No web form needed.
- **Domain:** activimpact.ai
- **Priority: 2.**

## Status

- Current: `submitted` (updated 2026-09-02)
- Reference: `gmail:1a0411b7a8000bc9`
...
1. Email `privacy@activimpact.ai` with the standard statutory deletion/opt-out
...
- **Legal entity:** ActivImpact, LLC
- **Trading as:** ActivImpact
- **Registered address:** 6543 S. Las Vegas Blvd. 2nd Floor, LAS VEGAS,
  NV, 89119
- **Filed contact email:** privacy@activimpact.ai
- **Filed phone:** 8582982268
- **Website:** activimpact.ai
