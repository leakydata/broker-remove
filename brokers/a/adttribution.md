...
- **Opt-out:** https://www.adttribution.com/opt-out.html
- **Email:** info@adttribution.com (verified)
- **Method:** web_form — Web form.
- **Domain:** adttribution.com
- **Priority: 2.**
...
1. **Open the opt-out page:** https://www.adttribution.com/opt-out.html
...
4. **Or email `hello@adttribution.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Adttribution Inc
- **Trading as:** Adttribution
- **Registered address:** 16192 Coastal Highway, Lewes, Delaware, 19958
- **Filed contact email:** hello@adttrbution.com
- **Filed phone:** 07833225062
- **Website:** www.adttribution.com
