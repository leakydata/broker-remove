...
- **Email:** none working — both known addresses bounced (see below)
- **Method:** email — Statutory request by email. No web form needed.
- **Domain:** agrgroupinc.com
- **Priority: 2.**
...
1. **Email `privacy@agrgroupinc.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** All Global Resources, LLC
- **Registered address:** 2925 N. Green Valley Parkway, Suite C,
  Henderson, NV
- **Filed contact email:** [named individual]@agrgroupinc.com
- **Website:** https://www.agrgroupinc.com
