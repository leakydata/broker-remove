...
- **Opt-out:** https://allpeople.com/removal
- **Email:** webmaster@allpeople.com (verified)
...
- Reference: `gmail:1a01043c6333cecb`
- Note: Statutory deletion + opt-out emailed from [EMAIL]. Full identifier set: 8 emails, 10 prior addresses, 9 phones, DOB, aliases. Asks them to search hashed email forms and prior identifiers, and pre-empts the residency deflection. Asked how many records matched and whether suppression applies to future feeds.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Open the opt-out page:** https://allpeople.com/removal
...
4. **Or email `webmaster@allpeople.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
