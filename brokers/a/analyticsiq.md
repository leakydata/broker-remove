...
- **Opt-out:** https://analytics-iq.com/opt-out-statistics/
- **Email:** privacy@analyticsiq.com (verified)
...
- Note: Recovered from the committed playbook brokers/a/analyticsiq.md, because the ledger carries no notes and this row's status had no evidence behind it: Statutory opt-out/deletion email sent 2026-08-23, category-tailored.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Open the opt-out page:** https://analytics-iq.com/opt-out-statistics/
...
4. **Or email `privacy@analyticsiq.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** AnalyticsIQ Inc
- **Registered address:** 6 Concourse Parkway Suite 1750, Atlanta, GA,
  30328
- **Filed contact email:** privacy@analyticsiq.com
- **Filed phone:** 8886124309
- **Website:** analytics-iq.com
