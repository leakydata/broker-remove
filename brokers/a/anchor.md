...
- **Opt-out:** https://ecom2.anchorcomputer.com/ccpa
- **Email:** privacyteam@anchorcomputer.com (verified)
...
1. **Open the opt-out page:** https://ecom2.anchorcomputer.com/ccpa
...
4. **Or email `[named individual]@anchorcomputer.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Anchor Computer Inc.
- **Registered address:** 1300 Walt Whitman Rd Suite 103,, Melville, NY,
  11747
- **Filed contact email:** [named individual]@anchorcomputer.com
- **Filed phone:** (631) 306-9336
- **Website:** http://www.anchorcomputer.com
