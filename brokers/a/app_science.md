...
- **Email:** privacy@appscience.inc (verified)
- **Method:** email — Statutory request by email. No web form needed.
- **Domain:** appscience.ai
- **Priority: 2.**
...
1. **Email `privacy@appscience.inc`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** App Science, Inc
- **Registered address:** 16350 Ventura Blvd, Suite D827, Encino, CA,
  91436
- **Filed contact email:** privacy@appscience.inc
