...
- **Opt-out:** https://instantdata.atdata.com/optout
- **Email:** privacy@atdata.com (verified)
...
1. **Open the opt-out page:** https://instantdata.atdata.com/optout
...
4. **Or email `privacy_support@atdata.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** AtData, LLC
- **Registered address:** 770 Legacy Pl Fl 2, Dedham, MA, 02026
- **Filed contact email:** privacy_support@atdata.com
- **Filed phone:** 3322404684
- **Website:** https://atdata.com
