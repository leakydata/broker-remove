...
- **Opt-out:** https://privacycompliance.biz/other-atozdatabases/
- **Method:** web — 
- **Domain:** atozdatabases.com
- **Priority: 3.**
...
1. Open `https://privacycompliance.biz/other-atozdatabases/`. Enter email address and full name.
...
AtoZdatabases is one of fourteen brands run through a single compliance portal by one
