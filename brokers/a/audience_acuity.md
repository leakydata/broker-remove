...
- **Opt-out:** https://audienceacuity.com/opt-out-of-database/
- **Email:** privacy@audienceacuity.com (verified)
...
1. **Open the opt-out page:** https://audienceacuity.com/opt-out-of-database/
...
4. **Or email `privacy@audienceacuity.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Audience Acuity LLC
- **Trading as:** Audience Acuity
- **Registered address:** 10845 Griffith Peak Dr., Suite 200, LAS VEGAS,
  Nevada, 89135
- **Filed contact email:** privacy@audienceacuity.com
- **Filed phone:** 4439943679
- **Website:** audienceacuity.com
