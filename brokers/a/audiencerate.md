...
- **Opt-out:** https://www.audiencerate.com/optout
- **Email:** privacy@audiencerate.com (verified)
...
1. **Open the opt-out page:** https://www.audiencerate.com/optout
...
4. **Or email `admin@audiencerate.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Audiencerate Limited
- **Registered address:** 7 Bell Yard, London, UK
- **Filed contact email:** admin@audiencerate.com
- **Website:** https://www.audiencerate.com
