...
- Current: `pending`
- **STOPPED ASKING 2026-09-03 (§299).** Three rounds, three automated nils. The template DID genuinely improve after the §278 comparison letter -- from 'your request to exercise your right has been completed' to naming the right AND stating the outcome -- and that improvement reaches every future requester of theirs. But the substantive question, whether a STANDING do-not-add entry was recorded, went unanswered three times, and the last attempt was answered with a third copy of the message it was asking about. DO NOT PRESS AGAIN: a fourth letter would reach the same automation. Recorded as suppressed on the original standing-suppression ask plus a stated nil.
