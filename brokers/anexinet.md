...
- **Note (2026-09-06):** that same 2026-09-03 duplicate send to dpo@verinext.com bounced too — see `verinext.md` for the full account (recorded as `rejected_ambiguous`, not confirmed dead; the original 8/20 send to the same address never bounced). No action needed on this row; it already points at the sibling.
