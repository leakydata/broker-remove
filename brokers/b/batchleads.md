...
- **Email:** ops@equimine.com (verified)
...
1. **Email `[named individual]@equimine.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** EquiMine Inc.
- **Trading as:** BatchLeads
- **Registered address:** 26457 Rancho Parkway South, Lake Forest, CA,
  92630
- **Filed contact email:** [named individual]@equimine.com
- **Filed phone:** 877-204-9040
- **Website:** www.batchleads.io
