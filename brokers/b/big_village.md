...
- **Opt-out:** https://big-village.com/do-not-sell-or-share-my-personal-information/
- **Email:** dpo_US@big-village.com (verified)
- **Method:** web_form — Web form.
- **Domain:** big-village.com
- **Priority: 2.**
...
1. **Open the opt-out page:** https://big-village.com/do-not-sell-or-share-my-personal-information/
...
4. **Or email `[named individual]@brightmountainmedia.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** BV Insights LLC
- **Registered address:** 6400 Congress Avenue, Suite 2050, Boca Raton,
  FL, 33487
- **Filed contact email:** [named individual]@brightmountainmedia.com
- **Filed phone:** 646-516-6824
- **Website:** www.big-village.com
