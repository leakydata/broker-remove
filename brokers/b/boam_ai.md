...
- **Email:** privacy@boam.com (verified)
...
- Note: 2026-08-25: emailed privacy@boam.com. Category unclear, so used the two questions that pay off regardless: name your upstream suppliers (the single highest-yield question we ask - it has surfaced brokers absent from every state registry), and disclose inferred/modelled/scored attributes separately from collected ones.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Email `privacy@boam.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Gigabite Inc
- **Trading as:** Boam AI
- **Registered address:** 252 NW 29th St, Floor 9, Miami, FL, 33127
- **Filed contact email:** privacy@boam.com
- **Filed phone:** 4086135720
- **Website:** https://boam.ai
