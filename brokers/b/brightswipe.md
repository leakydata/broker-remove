...
1. **Email `admin@brightswipe.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** BrightSwipe Inc
- **Registered address:** 1451 W. Cypress Creek Rd., Suite 300, Fort
  Lauderdale, FL 33309, United States
- **Filed contact email:** admin@brightswipe.com
- **Website:** http://brightswipe.com
- **Opt-out route they filed:** BrightSwipe will have a website to
  respond to an individualâ€™s written demand to remove the
  individualâ€™s information from the website. We do not intend to
  maintain these profiles public. Brightswipe will handle these requests
  on a case-by-case basis in the unlikely event that Brightswipe has made
  the covered information public.
- **Route for protected individuals:** BrightSwipe will have a website to
  respond to an individualâ€™s written demand to remove the
  individualâ€™s information from the website. We do not intend to
  maintain these profiles public. Brightswipe will handle these requests
  on a case-by-case basis in the unlikely event that Brightswipe has made
  the covered information public (Cal. Gov. Code 6208.1(b) /
