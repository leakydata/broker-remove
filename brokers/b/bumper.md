...
- **Opt-out:** https://www.bumper.com/svc/optout/search/comprehensive_optouts
- **Email:** privacy@bumper.com (verified)
...
1. **Open the opt-out page:** https://www.bumper.com/svc/optout/search/comprehensive_optouts
...
4. **Or email `privacy@bumper.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
