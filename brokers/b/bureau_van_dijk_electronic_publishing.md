...
1. **Open the opt-out page:** https://www.bvdinfo.com/en-gb/legal/personal-data-request-form
...
4. **Or email `privacy@moodys.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Bureau van Dijk Electronic Publishing Ltd.
- **Registered address:** 1 Canada Square, Canary Wharf, London, E14 5FA,
  United Kingdom
- **Filed contact email:** privacy@bvdinfo.com
- **Website:** https://www.bvdinfo.com/en-us/
- **Opt-out route they filed:** https://www.bvdinfo.com/en-gb/legal/personal-data-request-form
- **Route for protected individuals:** https://www.bvdinfo.com/en-gb/legal/personal-data-request-form
