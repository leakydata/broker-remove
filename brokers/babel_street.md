...
- **This is the CAPTCHA-equivalent stopping point:** SMS MFA to [FIRST]'s phone cannot be completed by this project (no browser, no phone access). Queued for handoff — see `scripts/handoff.py`.
