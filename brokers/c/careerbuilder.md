...
- **Opt-out:** https://edge.careerbuilder.com/optout
- **Email:** riskandcompliance@careerbuilder.com (verified)
...
1. **Open the opt-out page:** https://edge.careerbuilder.com/optout
...
4. **Or email `riskandcompliance@careerbuilder.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** CareerBuilder, LLC
- **Registered address:** 200 N. LaSalle Street, Suite 900, Chicago, IL
- **Filed contact email:** riskandcompliance@careerbuilder.com
