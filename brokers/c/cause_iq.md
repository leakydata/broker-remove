...
- **Opt-out:** https://www.causeiq.com/privacy_policy/ccpa/
- **Email:** help@causeiq.com (verified)
...
1. **Open the opt-out page:** https://www.causeiq.com/privacy_policy/ccpa/
...
4. **Or email `help@causeiq.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
