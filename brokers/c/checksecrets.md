...
- **The reply is a template scoped to one hostname.** It confirms removal "from
  our database at https://www.checksecrets.com" and silently ignores a request framed as
