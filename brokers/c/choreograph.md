...
1. **Open the opt-out page:** https://amer-cpp.choreograph.com/manage-your-data/do-not-sell
...
4. **Or email `[named individual]@choreograph.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Choreograph LLC
- **Registered address:** 175 Greenwich Street, New York, NY, 10007
- **Filed contact email:** [named individual]@choreograph.com
- **Filed phone:** 4156120051
