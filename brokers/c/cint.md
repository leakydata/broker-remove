...
- **Email:** privacy@Cint.com (verified)
...
1. **Email `compliance@cint.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Cint USA, Inc.
- **Registered address:** 1235 Saint Thomas Street Suite 201, New
  Orleans, LA
- **Filed contact email:** compliance@cint.com
