...
- **Opt-out:** https://www.city-data.com/delrequest/form.php
- **Email:** others@city-data.com (verified)
...
1. **Open the opt-out page:** https://www.city-data.com/delrequest/form.php
...
4. **Or email `[named individual]@city-data.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
