...
- **Opt-out:** https://blog.cloudlead.co/2020/07/24/opt-out-in-cold-emails/
- **Email:** support@cloudlead.co (verified)
...
1. **Open the opt-out page:** https://blog.cloudlead.co/2020/07/24/opt-out-in-cold-emails/
...
4. **Or email `hello@cloudlead.co`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
