...
1. **Open the opt-out page:** https://www.cognism.com/data-opt-out
...
4. **Or email `privacy@cognism.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Cognism
- **Registered address:** 33 Arch Street, Boston, MA, 02110
- **Filed contact email:** privacy@cognism.com
- **Filed phone:** 6503725001
