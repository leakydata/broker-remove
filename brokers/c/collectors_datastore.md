# Collectors Datastore LLC

- **Email:** hdenniston@ludex.ai (verified)
- **Method:** email — Statutory request by email. No web form needed.
- **Domain:** thecollectorsdatastore.com
- **Priority: 2.**
...
1. **Email `[named individual]@ludex.ai`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
