# Commercial Real Estate Exchange — DUPLICATE ROW, DO NOT WRITE TO IT

- **Status:** `covered_by_sibling`
- **This is Crexi.** The request is already filed under **[crexi.md](./crexi.md)**, which is at `submitted`.
...
next to both: `privacy@crexi.com`.
...
Anything learned about this company belongs in [crexi.md](./crexi.md).
...
- **Legal entity:** Commercial Real Estate Exchange, Inc.
- **Trading as:** Crexi
- **Registered address:** 5510 Lincoln Blvd., Suite 400, Playa Vista, CA
- **Filed contact email:** privacy@crexi.com
...
1. **Email `privacy@crexi.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
