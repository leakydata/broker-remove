...
- **Opt-out:** https://www.compile.com/hcp-opt-out/
- **Email:** privacy@compile.com (verified)
...
1. **Open the opt-out page:** https://www.compile.com/hcp-opt-out/
...
4. **Or email `[named individual]@compile.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Compile, Inc.
- **Registered address:** 405 El Camino Real #608, Menlo Park, CA
- **Filed contact email:** [named individual]@compile.com
- **Filed phone:** 4159964259
- **Website:** https://www.compile.com
