...
- **Opt-out:** http://www.contractorscalifornia.org/about#contact
- **Email:** contact@licensedata.org (verified)
- **Method:** web_form — Web form.
- **Domain:** contractorscalifornia.org
- **Priority: 2.**

## Status

- Current: `submitted` (updated 2026-08-16)
- Reference: `gmail:1a00c87905780a1a`
- Note: Covered by ONE consolidated letter naming all 10 licensedata.org properties. California-based so CCPA applies directly. Asked for written confirmation even if no record exists, plus suppression against future creation.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Open the opt-out page:** http://www.contractorscalifornia.org/about#contact
...
4. **Or email `contact@licensedata.org`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
