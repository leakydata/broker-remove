...
- **Opt-out:** https://courtcasefinder.com/optout
- **Email:** privacy@courtcasefinder.com (verified)
- **Method:** web_form — Web form.
- **Domain:** courtcasefinder.com
- **Priority: 2.**
...
1. **Open the opt-out page:** https://courtcasefinder.com/optout
...
4. **Or email `privacy@courtcasefinder.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
