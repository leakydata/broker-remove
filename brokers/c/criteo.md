...
1. **Open the opt-out page:** https://www.criteo.com/privacy/
...
4. **Or email `dpo@criteo.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Criteo Corp.
- **Registered address:** 387 Park Ave South 12th Floor, New York, NY,
  10016
- **Filed contact email:** dpo@criteo.com
- **Filed phone:** 646 410 0400
