...
- **Opt-out:** https://datadelivers.com/do-not-sell-or-share-personal-information
- **Email:** privacy@datadelivers.com (verified)
- **Method:** web_form — Web form.
- **Domain:** datadelivers.com
- **Priority: 2.**
...
1. **Open the opt-out page:** https://datadelivers.com/do-not-sell-or-share-personal-information
...
4. **Or email `privacy@datadelivers.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** DataDelivers, LLC
- **Registered address:** 100 West Hillcrest Blvd Ste. 406, Schaumburg,
  Illinois, 60195
- **Filed contact email:** privacy@datadelivers.com
- **Filed phone:** 6306352400
- **Website:** datadelivers.com
