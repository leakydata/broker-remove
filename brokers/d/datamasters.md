...
- **Email:** sales@datamasters.org (verified)
- **Method:** email — Statutory request by email. No web form needed.
- **Domain:** datamasters.org
- **Priority: 2.**
...
1. **Email `sales@datamasters.org`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Datamasters
- **Registered address:** 6701 Long Prairie Rd # 744-149, Flower Mound,
  TX
- **Filed contact email:** [named individual]@gmail.com
