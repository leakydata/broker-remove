...
- 2026-09-22 reply: their B2B database is keyed to institutional emails and company domains, not personal webmail, so the Gmail-domain addresses supplied weren't sufficient to search (see CONTRIBUTING.md "A B2B letter that lists only consumer webmail cannot find anything"). Replied 2026-09-23 with a former institutional address and a public profile URL as better search keys. Awaiting their response.
