...
- **Email:** support@dealmachine.com (verified)
...
1. **Email `support@dealmachine.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** DealMachine Operations Inc.
- **Trading as:** DealMachine
- **Registered address:** 456 N Meridian Ste, STE 44050, Indianapolis,
  IN, 46204
- **Filed contact email:** support@dealmachine.com
- **Filed phone:** 3176807701
