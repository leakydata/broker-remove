...
- **Opt-out:** https://privacy.deepsync.com/
...
1. **Open the opt-out page:** https://privacy.deepsync.com/
...
4. **Or email `legal@deepsync.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Compact Information Systems, LLC
- **Trading as:** Deep Sync
- **Registered address:** 6720 108th Avenue NE, Suite 200, Kirkland,
  Washington, 98033-7050
- **Filed contact email:** privacy.compliance@deepsync.com
- **Filed phone:** 8889707248
- **Website:** https://deepsync.com
