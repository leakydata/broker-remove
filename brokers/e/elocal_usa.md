...
- **Email:** privacy@elocal.com (verified)
...
1. **Email `privacy@elocal.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- If a record exists despite no memory of ever contacting them, the source
  is the useful fact — could be a data broker upstream rather than a genuine
  lead submission. Ask specifically.
...
- **Legal entity:** eLocal USA, LLC
- **Registered address:** 1010 Spring Mill Ave Ste 200, Conshohocken, PA,
  19428
- **Filed contact email:** privacy@elocal.com
- **Filed phone:** 6106296449
- **Website:** elocal.com
