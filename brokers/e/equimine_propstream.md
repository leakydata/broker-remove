...
- Note: Recovered from the committed playbook brokers/e/equimine_propstream.md, because the ledger carries no notes and this row's status had no evidence behind it: Statutory opt-out/deletion email sent 2026-08-23, category-tailored.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Open the opt-out page:** https://www.propstream.com/your-privacy-choices
...
4. **Or email `privacyinquiry@propstream.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Equimine
- **Trading as:** PropStream
- **Registered address:** 26457 Rancho Parkway South, Lake Forest, CA
- **Filed contact email:** privacyinquiry@propstream.com
- **Filed phone:** (877) 204-9040
