...
1. **Open the opt-out page:** https://www.esiteanalytics.com/privacy-policy/
...
4. **Or email `privacy@kalibrate.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** eSite Analytics, Inc.
- **Trading as:** Kalibrate
- **Registered address:** 528 Johnnie Dodds Blvd, Ste 201, Mt Pleasant,
  SC
