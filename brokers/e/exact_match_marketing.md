...
1. **Email `datarequest@exactmatch.io`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Exact Match Marketing Inc
- **Registered address:** 895 Dietrich Ct, Newark, OH, 43055
- **Filed contact email:** datarequest@exactmatch.io
- **Filed phone:** (740) 527-8020
- **Website:** exactmatchmarketing.com; app.exactmatchmarketing.com;
  exactmatch.io
