...
- **Opt-out:** https://contact.ezlocal.com/form/remove-listing/
- **Email:** privacy@ezlocal.com (verified)
...
1. **Open the opt-out page:** https://contact.ezlocal.com/form/remove-listing/
...
4. **Or email `privacy@ezlocal.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
