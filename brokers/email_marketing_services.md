...
- **Confirmed (2026-09-06):** `dataprivacy@listmatch.co` did in fact hard-bounce (three separate 550s, first seen 2026-08-29) — recorded in `data/dead_addresses.json`. That's now three dead aliases at this company (`dataprivacy@listmatch.com`, `dataprivacy2026@listmatch.com`, `dataprivacy@listmatch.co`) and one that works because it's a person, not a mailbox: `jonathan@listmatch.com`. No further action — this thread is already closed.
