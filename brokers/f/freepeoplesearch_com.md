# Freepeoplesearch Com — DUPLICATE ROW, DO NOT WRITE TO IT

- **Status:** `covered_by_sibling`
- **This is FreePeopleSearch.** The request is already filed under **[freepeoplesearch.md](./freepeoplesearch.md)**, which is at `confirmed`.
...
next to both: `operations@freepeoplesearch.com`.
...
Anything learned about this company belongs in [freepeoplesearch.md](./freepeoplesearch.md).
...
- **Legal entity:** FREEPEOPLESEARCH.COM, LLC
- **Registered address:** 360 Central Ave STE 800, St. Petersburg,
  Florida, 33701
- **Filed contact email:** compliance@freepeoplesearch.com
- **Filed phone:** 561-349-7313
- **Website:** freepeoplesearch.com
...
1. **Email `compliance@freepeoplesearch.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
