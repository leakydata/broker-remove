...
- **Email:** privacy@gravyanalytics.com (verified)
...
1. **Email `privacy@gravyanalytics.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Gravy Analytics, Inc.
- **Registered address:** 44679 Endicott Dr Suite 300, Ashburn, VA
- **Filed contact email:** privacy@gravyanalytics.com
