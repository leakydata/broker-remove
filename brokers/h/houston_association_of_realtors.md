...
- **Opt-out:** https://www.har.com/question/27460_how-can-i-opt-out-of-the-zillow-listing
- **Email:** privacy@har.com (verified)
...
1. **Open the opt-out page:** https://www.har.com/question/27460_how-can-i-opt-out-of-the-zillow-listing
...
4. **Or email `privacy@har.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
