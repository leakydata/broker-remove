# Hunter Web Services — DUPLICATE ROW, DO NOT WRITE TO IT

- **Status:** `covered_by_sibling`
- **This is Hunter.io.** The request is already filed under **[hunter.md](./hunter.md)**, which is at `replied`.
...
next to both: `privacy@hunter.io`.
...
Anything learned about this company belongs in [hunter.md](./hunter.md).
...
- **Legal entity:** Hunter Web Services, Inc
- **Registered address:** 2810 N Church St, Wilmington, Delaware, 50754
- **Filed contact email:** [named individual]@hunter.io
- **Filed phone:** (617)631-0371
- **Website:** hunter.io
...
1. **Email `[named individual]@hunter.io`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
