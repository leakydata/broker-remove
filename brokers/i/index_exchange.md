...
- **Email:** privacy@indexexchange.com (verified)
...
1. **Email `privacy@indexexchange.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Index Exchange Inc.
- **Registered address:** 8 Spadina Ave. Suite 2900, Toronto, Ontario,
  M5V 0S8
- **Filed contact email:** privacy@indexexchange.com
- **Filed phone:** 4167855908
