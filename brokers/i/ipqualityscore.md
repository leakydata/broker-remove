...
- **Opt-out:** https://www.ipqualityscore.com/domain-reputation/optout.networkadvertising.org
- **Email:** Support@IPQualityScore.com (verified)
...
1. **Open the opt-out page:** https://www.ipqualityscore.com/domain-reputation/optout.networkadvertising.org
...
4. **Or email `Support@ipqualityscore.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
