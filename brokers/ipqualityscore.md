...
- **Email:** Support@ipqualityscore.com (discovered 2026-09-12 — not yet verified by a reply)
- **Method:** email
- **Domain:** ipqualityscore.com — fraud-scoring / risk-assessment service.
- **Priority: 1.**
...
2. If asked for a device/IP/cookie identifier to "look up the record",
   decline for the same reason as any adtech/fraud platform — see
   azerion.md for the identical trap and why the honest alternative is
   asking what they key on rather than supplying a fresh identifier.
