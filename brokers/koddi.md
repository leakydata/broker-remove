...
- **STOPPED ASKING 2026-09-03 (§299).** The 1798.120 opt-out wedge was put to them and the identical macro came back. That macro states the position I had asked for -- 'we are unable to accept privacy rights requests via email' -- and I undertook to record it and stop. DO NOT PRESS AGAIN BY EMAIL: three letters have produced three copies of the same autoresponse, and an autoresponder cannot distinguish a letter about the process from a request submitted through it. The form at koddi.com/dsr-form is queued for handoff and is the only live route. Worth recording for the pattern file: the macro demands three things a consumer structurally cannot supply -- no 'alias' email addresses, no UNHASHED NAMES, and 'the specific email address associated with your digital commerce activities', which is the thing the request exists to discover.
