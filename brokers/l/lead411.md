...
- **Email:** lead411_privacy@l4mail.com — **unverified, may bounce**
...
1. **Email `[named individual]@lead411.io`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
