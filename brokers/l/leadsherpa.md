...
- **Email:** compliance@propertyreach.com (verified)
...
- Note: 2026-08-29 COVERED BY CANONICAL (SILENT_FAILURES 177). duplicate_of=propertyreach, and both rows carry the identical address compliance@propertyreach.com -- so the canonical row 'propertyreach' hit the same obstacle at this same address. Not a separate send: the mailbox has the request, and whether the company files it under one brand name or the other is internal to them. Status set here so the queue stops offering a second letter to an address that already has one. NOT marked confirmed -- no confirmation was received for this row.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Email `compliance@propertyreach.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Property Reach, L.P.
- **Trading as:** LeadSherpa
- **Registered address:** 5473 Blair Rd Ste 100 PMB 75659, Dallas, TX,
  75659
- **Filed contact email:** compliance@propertyreach.com
- **Filed phone:** 8775519855
- **Website:** propertyreach.com; leadsherpa.com
