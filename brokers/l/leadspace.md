...
- **Email:** compliance_privacy@leadspace.com (verified)
...
1. **Email `compliance_privacy@leadspace.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Leadspace Inc
- **Trading as:** Leadspace
- **Registered address:** 122 Grand Street, New York, NY
- **Filed contact email:** compliance_privacy@leadspace.com
- **Filed phone:** +1855-532-3772
