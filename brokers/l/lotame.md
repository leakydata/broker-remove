...
- **Opt-out:** https://www.lotame.com/privacy/
- **Email:** info@lotame.com (verified)
...
1. **Open the opt-out page:** https://www.lotame.com/privacy/
...
4. **Or email `privacy@lotame.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Lotame Solutions, Inc.
- **Registered address:** 8890 McGaw Road, Suite 250, Columbia, MD
- **Filed contact email:** privacy@lotame.com
