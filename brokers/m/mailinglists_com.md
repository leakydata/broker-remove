...
- **Email:** unsubscribe@mailinglists.com (verified)
- **Method:** email — Statutory request by email. No web form needed.
- **Domain:** mailinglists.com
- **Priority: 2.**
...
1. **Email `unsubscribe@mailinglists.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- No dedicated privacy/CCPA contact is published anywhere findable on the site as of 2026-08-30 — only a marketing-list unsubscribe address. If a reply never comes, the next step is checking the site footer for a "Do Not Sell" or CCPA-specific link before assuming the company ignores requests outright.
...
- **Legal entity:** Infinite Media Concepts, Inc.
- **Trading as:** Mailinglists.com
- **Registered address:** 190 East Post Road, White Plains, New York,
  10601
- **Filed contact email:** unsubscribe@mailinglists.com
- **Filed phone:** 914-948-8300
- **Website:** mailinglists.com
