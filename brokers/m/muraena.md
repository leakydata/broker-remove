...
- Note: Adopted from the shared ledger: another agent recorded 'suppressed' on 2026-09-16. No detail is carried across — re-read the broker's own reply before relying on this.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Email `support@muraena.ai`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
