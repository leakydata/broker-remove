...
- **Reply (2026-08-31):** ignored the DPPA/VIN/derived-attribute letter entirely and said only "Please submit your request into our Personal Information Request Form so we can process your request securely and accurately." No answer to any of the four numbered questions.
- **OneTrust portal (2026-09-05 onward):** a portal ticket (Request ID AV6KDQ7SS4) appeared despite no form ever having been submitted from this side — likely auto-created from the emailed request. It first asked for an email-confirmation click, then (2026-09-10) a "comment has been added" notice. Both require opening a browser-based privacy portal; no further email channel is offered. Queued for handoff.
