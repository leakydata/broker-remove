...
- **Opt-out:** https://nativeamericannetroots.net/diary/51
- **Email:** support@nativeamericannetroots.net (verified)
- **Method:** unknown — Route not yet established.
- **Domain:** nativeamericannetroots.net
- **Priority: 1.**
...
1. **Open the opt-out page:** https://nativeamericannetroots.net/diary/51
...
4. **Or email `support@nativeamericannetroots.net`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
