...
- **Opt-out:** https://privacy.xing.com/en/privacy-policy/what-rights-can-you-assert/right-of-access
- **Email:** info@xing.com (verified)
...
1. **Open the opt-out page:** https://privacy.xing.com/en/privacy-policy/what-rights-can-you-assert/right-of-access
...
4. **Or email `info@xing.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
