...
- **Legal entity:** The Open Data People, Inc. DBA openpeoplesearch.com
- **Registered address:** 32605 Temecula Pkwy 216, Temecula, CA 92592,
  United States
- **Filed contact email:** info@openpeoplesearch.com
- **Website:** http://openpeoplesearch.com
- **Opt-out route they filed:** Go to openpeoplesearch.com, scroll to the
  page bottom and click Do Not Sell My Personal Information (CA Residents
  Only).
- **Route for protected individuals:** Go to openpeoplesearch.com, scroll
  to the page bottom and click Remove My Info. (Cal. Gov. Code 6208.1(b)
  ...
  request)
- **What they say they collect:** All data collected and stored is public
  data. We allow anyone to remove their information.
