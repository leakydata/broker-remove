...
- **Email:** legal@optable.co (verified)
...
- **2026-09-22 follow-up, then closed out.** Two weeks after sending the codes they followed up noting none had come back, and reiterated the deletion/opt-out/suppression is unaffected: "The deletion, opt-out and suppression part of your request does not depend on those codes and is in hand." Replied declining to chase the unreachable mailboxes further and asked them to close the right-to-know portion as unverified rather than leave the ticket open — the suppression outcome is the one that matters and stands regardless. **Worth reusing as a pattern:** when a broker gates only the *disclosure* half behind verification and has already completed deletion/suppression unconditionally, explicitly releasing the disclosure half (rather than letting the ticket linger) closes the loop cleanly and gets a confirmed status instead of a permanently-open one.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Email `legal@optable.co`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Optable Technologies US Inc.
- **Trading as:** Optable
- **Registered address:** 1209 Orange Street, Wilmington, DE, 19801
- **Filed contact email:** legal@optable.co
- **Filed phone:** 3023943980
- **Website:** www.optable.co
