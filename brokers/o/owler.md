...
- **Email:** support@owler.com (verified)
...
1. **Email `support@owler.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- The subject has no known executive listing; if a reply cites a company
  ...
  project-wide "never guess which record is the user's" rule.
