...
- **Email:** info@peekyou.com (verified)
...
1. **Open the opt-out page:** https://www.peekyou.com/about/contact/optout/
...
4. **Or email `info@peekyou.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** PeekYou LLC
- **Registered address:** 44715 Prentice Drive, Dulles, VA
- **Filed contact email:** info@peekyou.com
