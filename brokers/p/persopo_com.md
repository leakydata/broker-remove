...
- **Opt-out:** http://info.persopo.com/opt-out.html
- **Email:** privacy@persopo.com — **unverified, may bounce**
...
1. **Open the opt-out page:** http://info.persopo.com/opt-out.html
...
4. **Or email `privacy@persopo.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
