# ProspectBase UK Limited

- **Email:** privacy@prospectbase.com (state-registry / site-published address — unverified until a reply arrives)
- **Method:** email — Statutory request by email. No web form needed.
- **Domain:** prospectbase.com
- **Priority: 2.**
...
1. **Email `privacy@prospectbase.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** ProspectBase UK Limited
- **Registered address:** Wessex House, Teign Road, Newton Abbot, Devon,
  TQ12 4AA
- **Filed contact email:** privacy@prospectbase.com
- **Filed phone:** 20 3695 7895
- **Website:** www.prospectbase.com
