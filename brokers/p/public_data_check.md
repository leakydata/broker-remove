...
- **Opt-out:** https://www.publicdatacheck.com/help-center/privacy-requests
- **Email:** support@publicdatacheck.com — **unverified, may bounce**
- **Method:** web_form — Web form.
- **Domain:** publicdatacheck.com
- **Priority: 2.**
...
1. **Open the opt-out page:** https://www.publicdatacheck.com/help-center/privacy-requests
...
4. **Or email `privacyinfo@publicdatacheck.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** National Data Analytics, LLC
- **Trading as:** publicdatacheck.com
- **Registered address:** 5662 Calle Real Ste 107, Goleta, CA, 93117
- **Filed contact email:** privacyinfo@publicdatacheck.com
- **Filed phone:** 8009500953
- **Website:** publicdatacheck.com
