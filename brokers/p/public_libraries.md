...
- **Email:** netadmin@publiclibraries.com — **unverified, may bounce**
- **Method:** web_form — Web form.
- **Domain:** publiclibraries.com
- **Priority: 2.**
...
1. **Open the opt-out page:** https://www.truthfinder.com/opt-out/v2/submit/
...
4. **Or email `netadmin@publiclibraries.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
