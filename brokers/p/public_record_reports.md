...
- **Opt-out:** https://www.publicrecordreports.com/help-center/privacy-requests
- **Email:** support@publicrecordreports.com — **unverified, may bounce**
...
1. **Open the opt-out page:** https://www.publicrecordreports.com/help-center/privacy-requests
...
4. **Or email `support@publicrecordreports.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
