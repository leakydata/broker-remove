...
- **Opt-out:** https://www.publicsearcher.com/api/helper/optOutLight/search
- **Email:** support@publicsearcher.com — **unverified, may bounce**
- **Method:** web_form — Web form.
- **Domain:** publicsearcher.com
- **Priority: 2.**
...
1. **Open the opt-out page:** https://www.publicsearcher.com/api/helper/optOutLight/search
...
4. **Or email `support@publicsearcher.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
