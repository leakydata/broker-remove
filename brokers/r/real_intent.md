...
1. **Email `[named individual]@realintent.co`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** REAL INTENT INC
- **Registered address:** 8 The Green, Dover, DE, 19901
- **Filed contact email:** [named individual]@realintent.co
- **Filed phone:** 9492587296
- **Website:** https://realintent.co
