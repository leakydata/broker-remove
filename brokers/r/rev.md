...
- **Email:** privacy@getrev.ai — **unverified, may bounce**
...
1. **Email `privacy@getrev.ai`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** LeadCrunch Inc
- **Trading as:** Rev
- **Registered address:** 2150 Comstock st. #712979, San Diego, CA
- **Filed contact email:** privacy@getrev.ai
