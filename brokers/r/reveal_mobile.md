...
- **Email:** info@revealmobile.com (state-registry / site-published address — unverified until a reply arrives)
...
1. **Email `info@revealmobile.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Reveal Mobile, Inc.
- **Registered address:** 5540 Centerview Dr, Raleigh, NC, 27606
- **Filed contact email:** info@revealmobile.com
- **Filed phone:** 9195739701
