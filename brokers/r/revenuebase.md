...
- **Email:** privacy@revenuebase.ai (state-registry / site-published address — unverified until a reply arrives)
...
- Note: Recovered from the committed playbook brokers/r/revenuebase.md, because the ledger carries no notes and this row's status had no evidence behind it: 2026-08-26: emailed privacy@revenuebase.ai. Same B2B variant as rampedup.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Email `privacy@revenuebase.ai`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** RevenueBase, Inc
- **Trading as:** RevenueBase
- **Registered address:** 42 Clarendon Street, Newton, Massachusetts,
  02460
- **Filed contact email:** privacy@revenuebase.ai
- **Filed phone:** (617) 302-6275
- **Website:** revenuebase.ai
