...
1. **Email `[named individual]@ripple-fx.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Ripple Effect Strategies
- **Registered address:** 1 Morris St PO Box 30, Morris, NJ, 07963
- **Filed contact email:** [named individual]@ripple-fx.com
- **Filed phone:** 3012547533
- **Website:** ripple-fx.com; ripple-roi.com
