...
- **Email:** privacyofficer@therooftop.io (verified)
- **Method:** email — Statutory request by email. No web form needed.
- **Domain:** rooftopdigital.com
- **Priority: 2.**
...
1. **Email `privacyofficer@therooftop.io`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Rooftop Digital, LLC
- **Registered address:** 30401 Agoura Rd, Suite 100, Agoura Hills, CA
- **Filed contact email:** privacyofficer@therooftop.io
