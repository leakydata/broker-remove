...
- **Email:** privacy@safegraph.com (state-registry / site-published address — unverified until a reply arrives)
...
1. **Email `privacy@safegraph.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** SafeGraph Inc.
- **Registered address:** 1543 Mission St., Ste 300, SAN FRANCISCO, CA
  94103-2512, United States
- **Filed contact email:** privacy@safegraph.com
- **Website:** http://www.safegraph.com
- **Opt-out route they filed:** Consumers may opt out of sale or submit
  requests to SafeGraph by submitting their email and Advertising ID
  number here: https://www.safegraph.com/do-not-sell-my-info
- **Route for protected individuals:** SafeGraph does not display or
  permit the display of such information, or operate a website that
  involves user generated content. (Cal. Gov. Code 6208.1(b) /
  ...
  request)
- **What they say they collect:** Additional information about
  SafeGraph's data collection practices can be found here:
  https://www.safegraph.com/ccpa-privacy-policy
