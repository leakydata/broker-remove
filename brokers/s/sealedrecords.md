...
- **Opt-out:** https://www.sealedrecords.net/api/helper/optOutLight/search
- **Email:** support@sealedrecords.net — **unverified, may bounce**
- **Method:** web_form — Web form.
- **Domain:** sealedrecords.net
- **Priority: 2.**
...
1. **Open the opt-out page:** https://www.sealedrecords.net/api/helper/optOutLight/search
...
4. **Or email `support@sealedrecords.net`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
