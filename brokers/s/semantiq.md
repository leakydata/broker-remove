...
- **Email:** ops@semantiqhealth.com (state-registry / site-published address — unverified until a reply arrives)
- **Method:** email — Statutory request by email. No web form needed.
- **Domain:** semantiqhealth.com
- **Priority: 2.**
...
1. **Email `privacy@semantiqhealth.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** SEMANTIQ INC
- **Registered address:** 2261 Market Street STE 86944, San Francisco,
  California, 94114
- **Filed contact email:** [named individual]@semantiqhealth.com
- **Filed phone:** 5619339030
- **Website:** https://semantiqhealth.com
