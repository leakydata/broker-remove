...
- **Email:** info@semasio.com (state-registry / site-published address — unverified until a reply arrives)
...
1. **Email `info@semasio.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Semasio GmbH
- **Trading as:** Semasio
- **Registered address:** Mönkedamm 11, Hamburg, Hamburg, 20457
- **Filed contact email:** info@semasio.com
- **Filed phone:** 1728382410
- **Website:** www.semasio.com
