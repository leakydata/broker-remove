...
- **Email:** dataprotection@sharethrough.com (verified)
...
1. **Email `dataprotection@sharethrough.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Sharethrough
- **Registered address:** 5455 Av. de Gaspé #730, Montreal, Quebec,
  H2T3B3
- **Filed contact email:** dataprotection@sharethrough.com
- **Filed phone:** 888-881-6930
