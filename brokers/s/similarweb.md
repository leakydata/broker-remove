...
- **Email:** legal@similarweb.com (verified)
...
1. **Email `legal@similarweb.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Similarweb Ltd.
- **Registered address:** 33 Yitzhak Rabin Road, Givatayim, NA, 5348303
- **Filed contact email:** legal@similarweb.com
- **Filed phone:** 35447782
