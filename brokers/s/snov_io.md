...
- Note: Recovered from the committed playbook brokers/s/snov_io.md, because the ledger carries no notes and this row's status had no evidence behind it: Statutory opt-out/deletion email sent 2026-08-23, category-tailored.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Open the opt-out page:** https://snov.io/do-not-sell-my-personal-information
...
4. **Or email `[named individual]@snov.io`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Snovio Inc
- **Registered address:** 65 Wickliffe dr, Naples, Florida, 34110
- **Filed contact email:** [named individual]@snov.io
- **Filed phone:** 3477050819
- **Website:** snov.io
