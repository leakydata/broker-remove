...
- **Email:** privacy@sourcepathdigital.com (verified)
- **Method:** email — Statutory request by email. No web form needed.
- **Domain:** sourcepathdigital.com
- **Priority: 2.**
...
1. **Email `privacy@sourcepathdigital.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Source Path Digital
- **Registered address:** 231 North Main Street, Suite 16, Edwardsville,
  IL, 62025
- **Filed contact email:** privacy@sourcepathdigital.com
- **Filed phone:** 3146667284
- **Website:** sourcepathdigital.com
