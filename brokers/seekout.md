...
- Note: **Turned around after the LinkedIn URL was supplied as a suppression key.** The original letter (2026-08-31) already included the public LinkedIn profile URL, framed explicitly as a suppression key rather than a search hint (see CONTRIBUTING.md's B2B-letter guidance — this is the case it's for). SeekOut's human reply on 2026-09-11 confirmed: *"I can confirm that LinkedIn URL [SLUG] has been deleted from our system."* So the email route was never actually blocked on withholding the URL — it needed the URL supplied on our own terms, up front, as one identifier among several, not surrendered on demand mid-thread. Two follow-up questions sent 2026-09-12 (deletion vs. standing suppression; whether any customer's saved/exported copy is reachable; whether the email addresses were also searched) are open.
