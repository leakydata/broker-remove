...
- **Email:** california-opt-out@telesign.com (verified)
...
1. Email california-opt-out@telesign.com. Lead with residency (PA, no comprehensive privacy law) and ask them to act on policy grounds regardless of the mailbox's apparent CA-only framing.

## Gotchas

**Mailbox name pre-gates the request.** See `_DEFLECTIONS.md` §23 — write anyway and name it in the first paragraph.
