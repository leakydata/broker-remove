...
- **Email:** support@telguarder.com (verified)
...
- Note: Emailed support@telguarder.com 2026-09-17. Caller ID / call-blocking
  ...
  distinct from the bare caller-ID entry. No reply yet.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Email `support@telguarder.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- Lead with phone numbers, not name, for this category.
