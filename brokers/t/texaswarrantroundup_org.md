...
- **Opt-out:** https://texaswarrantroundup.org/InfoPayOpt-OutNew.pdf
- **Email:** support@VerifyRecords.com (verified)
- **Method:** web_form — Web form.
- **Domain:** texaswarrantroundup.org
- **Priority: 2.**
...
- Note: Covered by ONE consolidated letter naming all 4 verifyrecords properties. Arrest/warrant data: also asked them to disclose any entry attributed to the subject and its source, so an inaccurate record can be corrected rather than only suppressed.

## Steps

*Written for anyone, not just the person who filed the original request.*

1. **Open the opt-out page:** https://texaswarrantroundup.org/InfoPayOpt-OutNew.pdf
...
4. **Or email `support@VerifyRecords.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
