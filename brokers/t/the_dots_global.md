...
- **Opt-out:** https://the-dots.com/users/sophia-woodleigh-200258
- **Email:** help@the-dots.com (verified)
...
1. **Open the opt-out page:** https://the-dots.com/users/sophia-woodleigh-200258
...
4. **Or email `help@the-dots.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
