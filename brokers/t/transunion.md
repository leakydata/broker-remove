...
- **Opt-out:** https://www.transunion.com/consumer-privacy
- **Email:** privacy@transunion.com (verified)
...
1. **Open the opt-out page:** https://www.transunion.com/consumer-privacy
...
4. **Or email `privacy@transunion.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Trans Union LLC
- **Trading as:** TransUnion
- **Registered address:** 555 W Adams St, Chicago, IL, 60661
- **Filed contact email:** privacy@transunion.com
