...
1. **Email `privacy@truedata.co`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** TrueData Solutions, Inc.
- **Trading as:** TrueData
- **Registered address:** 1325 Palmetto St, Suite 108, Los Angeles, CA,
  90013
- **Filed contact email:** privacy@truedata.co
