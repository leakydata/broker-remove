...
- **Opt-out:** https://www.truthrecord.org/api/helper/optOutLight/search
- **Method:** email, with a bot-gated self-service form as the documented alternative
- **Domain:** truthrecord.org
- **Priority: 2.**
...
1. **Do not write to this site alone.** It is one of thirteen brands on a single
   ...
   to one domain.
2. Email `support@truthrecord.org` with the full identifier list, naming all thirteen sites
