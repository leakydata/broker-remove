...
- **Opt-out:** https://www.wellborn.com/privacy-policy/
- **Email:** [named individual]@wellborn.com (verified)
...
1. **Open the opt-out page:** https://www.wellborn.com/privacy-policy/
...
4. **Or email `[named individual]@wellborn.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
