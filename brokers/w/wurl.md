...
- **Email:** dataprotection@wurl.com (verified)
...
1. **Email `dataprotection@wurl.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** WURL, LLC
- **Trading as:** WURL
- **Registered address:** 1100 Page Mill Road, Palo Alto, CA, 94304
- **Filed contact email:** dataprotection@wurl.com
- **Filed phone:** 8008399646
- **Website:** https://www.wurl.com
