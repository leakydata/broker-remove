...
- **Email:** privacy@seekout.io (verified)
...
1. **Email `privacy@seekout.io`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** Zipstorm LLC
- **Registered address:** 2475 152nd Ave NE, Bldg 17 Suite 2475, Redmond,
  WA 98502, United States
- **Filed contact email:** privacy@seekout.io
- **Website:** http://seekout.io
- **Opt-out route they filed:** They can email us at [named
  individual]@seekout.io, call us at the toll free number listed under
  "do not sell my data" or fill out a form that is also under the "do not
  sell my data" tab.
- **Route for protected individuals:** They can email us at [named
  individual]@seekout.io, call us at the toll free number listed under
  "do not sell my data" or fill out a form that is also under the "do not
  sell my data" tab. (Cal. Gov. Code 6208.1(b) / 6254.21(c)(1) — for
