...
- **Opt-out:** https://privacyrequest.zoominfo.com/remove/verify
- **Email:** privacy@zoominfo.com (verified)
...
1. **Open the opt-out page:** https://privacyrequest.zoominfo.com/remove/verify
...
4. **Or email `privacy@zoominfo.com`** with a written request. Ask for four things explicitly — deletion, opt-out of sale and sharing, a direction to any third parties they sold to, and a **forward-looking suppression** so the record is not simply re-added at the next data import.
...
- **Legal entity:** ZoomInfo Technologies, LLC
- **Trading as:** ZoomInfo
- **Registered address:** 330 W Columbia Way, Floor 8, Vancouver, WA,
  98660
- **Filed contact email:** privacy@zoominfo.com
- **Filed phone:** 8669049666
